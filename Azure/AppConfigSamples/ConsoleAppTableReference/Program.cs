...
using ConsoleAppTableReference;
...
class Program
{
    ...
    static string StorageKey{ get; set; }
    ...
    private static async ValueTask<ConfigurationSetting> MapProductTableReference(ConfigurationSetting setting)
    {
        ...
        var tableClient = new TableClient(tableUri, tableName, new TableSharedKeyCredential("securestorvc", StorageKey));
