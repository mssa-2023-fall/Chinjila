...
ALTER TABLE [Application].[DeliveryMethods]
    ADD CONSTRAINT [UQ_Application_DeliveryMethods_DeliveryMethodName] UNIQUE NONCLUSTERED ([DeliveryMethodName] ASC);
GO
...
ALTER TABLE [Application].[DeliveryMethods]
    ADD CONSTRAINT [PK_Application_DeliveryMethods] PRIMARY KEY CLUSTERED ([DeliveryMethodID] ASC);
GO
