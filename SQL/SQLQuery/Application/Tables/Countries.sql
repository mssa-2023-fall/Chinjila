...
ALTER TABLE [Application].[Countries]
    ADD CONSTRAINT [PK_Application_Countries] PRIMARY KEY CLUSTERED ([CountryID] ASC);
GO
...
ALTER TABLE [Application].[Countries]
    ADD CONSTRAINT [UQ_Application_Countries_FormalName] UNIQUE NONCLUSTERED ([FormalName] ASC);
GO

ALTER TABLE [Application].[Countries]
    ADD CONSTRAINT [UQ_Application_Countries_CountryName] UNIQUE NONCLUSTERED ([CountryName] ASC);
GO
