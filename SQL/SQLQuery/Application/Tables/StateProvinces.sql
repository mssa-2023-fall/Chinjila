...
ALTER TABLE [Application].[StateProvinces]
    ADD CONSTRAINT [UQ_Application_StateProvinces_StateProvinceName] UNIQUE NONCLUSTERED ([StateProvinceName] ASC);
GO

ALTER TABLE [Application].[StateProvinces]
    ADD CONSTRAINT [PK_Application_StateProvinces] PRIMARY KEY CLUSTERED ([StateProvinceID] ASC);
GO
