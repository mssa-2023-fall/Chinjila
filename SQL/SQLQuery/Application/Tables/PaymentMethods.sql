...
ALTER TABLE [Application].[PaymentMethods]
    ADD CONSTRAINT [UQ_Application_PaymentMethods_PaymentMethodName] UNIQUE NONCLUSTERED ([PaymentMethodName] ASC);
GO

ALTER TABLE [Application].[PaymentMethods]
    ADD CONSTRAINT [PK_Application_PaymentMethods] PRIMARY KEY CLUSTERED ([PaymentMethodID] ASC);
GO
