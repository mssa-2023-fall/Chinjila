...
ALTER TABLE [Warehouse].[PackageTypes]
    ADD CONSTRAINT [UQ_Warehouse_PackageTypes_PackageTypeName] UNIQUE NONCLUSTERED ([PackageTypeName] ASC);
GO

ALTER TABLE [Warehouse].[PackageTypes]
    ADD CONSTRAINT [PK_Warehouse_PackageTypes] PRIMARY KEY CLUSTERED ([PackageTypeID] ASC);
GO
