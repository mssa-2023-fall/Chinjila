...
ALTER TABLE [Warehouse].[StockItems]
    ADD CONSTRAINT [PK_Warehouse_StockItems] PRIMARY KEY CLUSTERED ([StockItemID] ASC);
GO
...
ALTER TABLE [Warehouse].[StockItems]
    ADD CONSTRAINT [UQ_Warehouse_StockItems_StockItemName] UNIQUE NONCLUSTERED ([StockItemName] ASC);
GO
