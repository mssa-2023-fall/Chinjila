...
ALTER TABLE [Sales].[CustomerCategories]
    ADD CONSTRAINT [PK_Sales_CustomerCategories] PRIMARY KEY CLUSTERED ([CustomerCategoryID] ASC);
GO

ALTER TABLE [Sales].[CustomerCategories]
    ADD CONSTRAINT [UQ_Sales_CustomerCategories_CustomerCategoryName] UNIQUE NONCLUSTERED ([CustomerCategoryName] ASC);
GO
