...
ALTER TABLE [Sales].[Customers]
    ADD CONSTRAINT [UQ_Sales_Customers_CustomerName] UNIQUE NONCLUSTERED ([CustomerName] ASC);
GO
...
ALTER TABLE [Sales].[Customers]
    ADD CONSTRAINT [PK_Sales_Customers] PRIMARY KEY CLUSTERED ([CustomerID] ASC);
GO
