...
ALTER TABLE [Sales].[BuyingGroups]
    ADD CONSTRAINT [PK_Sales_BuyingGroups] PRIMARY KEY CLUSTERED ([BuyingGroupID] ASC);
GO
...
ALTER TABLE [Sales].[BuyingGroups]
    ADD CONSTRAINT [UQ_Sales_BuyingGroups_BuyingGroupName] UNIQUE NONCLUSTERED ([BuyingGroupName] ASC);
GO
