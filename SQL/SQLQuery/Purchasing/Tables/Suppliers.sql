...
ALTER TABLE [Purchasing].[Suppliers]
    ADD CONSTRAINT [PK_Purchasing_Suppliers] PRIMARY KEY CLUSTERED ([SupplierID] ASC);
GO
...
ALTER TABLE [Purchasing].[Suppliers]
    ADD CONSTRAINT [UQ_Purchasing_Suppliers_SupplierName] UNIQUE NONCLUSTERED ([SupplierName] ASC);
GO
