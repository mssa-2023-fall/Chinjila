...
ALTER TABLE [Purchasing].[SupplierCategories]
    ADD CONSTRAINT [PK_Purchasing_SupplierCategories] PRIMARY KEY CLUSTERED ([SupplierCategoryID] ASC);
GO

ALTER TABLE [Purchasing].[SupplierCategories]
    ADD CONSTRAINT [UQ_Purchasing_SupplierCategories_SupplierCategoryName] UNIQUE NONCLUSTERED ([SupplierCategoryName] ASC);
GO
